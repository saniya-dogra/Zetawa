...
const Hireforms = () => {
  ...
  const services = [
    { id: 'design', icon: '🎨', title: 'Design', description: 'Our web design team has ample years of experience in the core areas of design to build a website that you need.' },
    { id: 'development', icon: '💻', title: 'Development', description: 'Looking out for customized solutions for your websites? Our team will develop and deliver a website that\'ll serve your purpose.' },
    { id: 'marketing', icon: '📈', title: 'Marketing', description: 'With researched digital marketing, we will ensure that your business reaches the right audience at the right time.' }
  ];
  ...
  const handleSubmit = (e) => {
    ...
    const finalData = { ...formData, services: selectedServices, budget: selectedBudget };
    console.log('Form Data:', finalData);
  ...
  const customStyles = {
    pageBackground: { background: '#7e3a41ff', minHeight: '100vh', color: 'white' },
    formContainer: { background: 'rgba(255,255,255,0.1)', border: '1px solid rgba(255,255,255,0.2)' },
    sectionTitle: { color: '#2f2b2bff', borderBottom: '2px solid rgba(80,75,75,0.3)', paddingBottom: '12px' },
    formInput: { background: 'rgba(254,253,253,0.98)', color: '#2f2b2bff', border: '2px solid rgba(255,255,255,0.3)' },
    submitButton: { background: 'linear-gradient(45deg,#FFE4E1,#FFF0F5)', color: '#8B4B6B', borderRadius: '50px', padding: '1rem 2.5rem' }
  };
        ...
        <div className="container">
          <div className="row justify-content-center">
            <div className="col-12 col-lg-8">
              ...
              <div className="text-center mb-5 pt-5">
                <h2 className="display-1 mb-4 fw-light">Hire Our Team</h2>
                <p className="fs-4 fw-light">Let's Transform Your Vision Into Digital Reality</p>
              </div>
              ...
              <div className="p-5" style={customStyles.formContainer}>
                ...
                <form onSubmit={handleSubmit}>
                  ...
                  {/* ALL YOUR EXISTING SECTIONS REMAIN SAME */}
                  {/* (Contact, Services, Project, Budget, Additional Info) */}
