...
const app = express(); // IMPORTANT — you missed this earlier!
...
const allowedOrigins = [
  ...
  'https://zetawa.onrender.com',
  'https://zetawa-contact-backend.onrender.com'
];

// Logger to check incoming requests & origins
